package src.main.dsa.algorithms.linked_list.singly_linked_list.search;
...
public class Main {
    ...
    public static void main(String[] args) {
        IntNode node = src.main.dsa.algorithms.linked_list.singly_linked_list.array_to_linked_list.Main.arrayToList(new int[]{3, 7, 5});
...
//        IntNode temp = node;
//        int size = src.main.dsa.algorithms.linked_list.singly_linked_list.size.Main.sizeOfList(node);
//
//        for (int j = 0; j <= ; j++) {
//
//        }

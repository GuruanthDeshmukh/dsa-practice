package src.main.dsa.algorithms.linked_list.singly_linked_list.add;
...
//        System.out.println(node4.toString());
        ...
        IntNode node = src.main.dsa.algorithms.linked_list.singly_linked_list.array_to_linked_list.Main.arrayToList(new int[]{1, 2, 3, 4, 5});

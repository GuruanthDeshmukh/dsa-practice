package src.main.dsa.algorithms.linked_list.singly_linked_list.size;
...
public class Main {
    ...
    public static void main(String[] args) {
        IntNode node = src.main.dsa.algorithms.linked_list.singly_linked_list.array_to_linked_list.Main.arrayToList(new int[]{1, 3, 5, 7});

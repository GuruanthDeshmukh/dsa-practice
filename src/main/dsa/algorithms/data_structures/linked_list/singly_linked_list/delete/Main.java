package src.main.dsa.algorithms.data_structures.linked_list.singly_linked_list.delete;
...
public class Main {
    ...
    public static void main(String[] args) {
        IntNode node = src.main.dsa.algorithms.data_structures.linked_list.singly_linked_list.array_to_linked_list.Main.arrayToList(new int[]{1, 2, 3, 4, 5, 6, 7, 8});

...
//                52244275,123047899,493394237,922363607,378906890,188674257,222477309,902683641,860884025,339100162
     ...
     * @return Number of inversions needed
     */
...
//    private static long getInversionPrac(long[] arr, int n) {
//        return solvePrac(arr, 0, (0 + n)/2, n);
//    }
//
//    private static long solvePrac(long[] arr, int low, int mid, int high) {
//        if (0 == arr.length)
//            return 0;
//
//        long res =
